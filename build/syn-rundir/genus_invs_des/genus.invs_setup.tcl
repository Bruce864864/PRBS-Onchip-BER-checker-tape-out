...
# Design Import
################################################################################
source -quiet /w/apps4/Cadence/GENUS211/tools.lnx86/lib/cdn/rc/edi/innovus_procs_common_ui.tcl
...
pqos_eval { rcp::read_taf genus_invs_des/genus.subdesign_attributes.taf.gz}

# Reading minimum routing layer data file
################################################################################
pqos_eval {rcp::load_min_layer_file genus_invs_des/genus.min_layer {METAL1 METAL2 METAL3 METAL4 METAL5 METAL6} {1 2 3 4 5 6}}
