...
# Generated on: Wed Apr 01 13:49:12 PDT 2026 (Wed Apr 01 20:49:12 UTC 2026)
...
set logfile fv/prbs15_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/prbs15_top -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /w/home.09/home/liyuyao864/ee209/prbs_project/rtl/prbs15_core.sv /w/home.09/home/liyuyao864/ee209/prbs_project/rtl/prbs15_ctrl.sv /w/home.09/home/liyuyao864/ee209/prbs_project/rtl/prbs15_top.sv
elaborate_design -golden -root {prbs15_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/prbs15_top/fv_map.v.gz
elaborate_design -revised -root {prbs15_top}
...
#add_name_alias fv/prbs15_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.prbs15_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.prbs15_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.prbs15_top.rtl.fv_map.rpt
