...
# Generated on: Sat Apr 11 11:58:38 PDT 2026 (Sat Apr 11 18:58:38 UTC 2026)
...
set logfile fv/prbs_ber_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/prbs_ber_top -revised fv_map
...
elaborate_design -golden -root {prbs_ber_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/prbs_ber_top/fv_map.v.gz
elaborate_design -revised -root {prbs_ber_top}
...
#add_name_alias fv/prbs_ber_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.prbs_ber_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.prbs_ber_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.prbs_ber_top.rtl.fv_map.rpt
