...
#  Created on Fri Apr 24 19:47:38 2026                
#                                                     
#######################################################
...
edit_pin -fixed_pin -pin {clk rst_n ext_serial_in busy done prbs_out bit_error} -hinst prbs_ber_pad_top \
  -pattern fill_layer -layer { METAL2 METAL4 } \
  -side left -start {0 260} -end {0 740}
puts "edit_pin bottom-side cfg pins"
edit_pin -fixed_pin -pin {cfg_sclk cfg_cs_n cfg_mosi cfg_miso} -hinst prbs_ber_pad_top \
  -pattern fill_layer -layer { METAL2 METAL4 } \
  -side bottom -start {300 0} -end {700 0}
