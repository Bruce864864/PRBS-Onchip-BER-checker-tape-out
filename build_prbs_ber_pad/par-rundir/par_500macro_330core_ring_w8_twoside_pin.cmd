...
#  Created on Sat Apr 25 15:04:42 2026                
#                                                     
#######################################################
...
set pg_area_m4 {84.88 68.0 415.28 432.3}
set pg_area_m5 {68.0 84.88 432.3 415.28}
...
puts "edit_pin left-side main pins"
edit_pin -fixed_pin -pin {clk rst_n ext_serial_in busy done bit_error} -hinst prbs_ber_pad_top \
  -pattern fill_optimised -layer { METAL2 METAL4 } \
  -side left -start {0 110} -end {0 390}
puts "edit_pin bottom-side cfg/output pins"
edit_pin -fixed_pin -pin {cfg_sclk cfg_cs_n cfg_mosi cfg_miso prbs_out} -hinst prbs_ber_pad_top \
  -pattern fill_optimised -layer { METAL2 METAL4 } \
  -side bottom -start {110 0} -end {390 0}
