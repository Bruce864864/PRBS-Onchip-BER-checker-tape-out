...
create_analysis_view -name WCCOM.setup_view -constraint_mode my_constraint_mode -delay_corner WCCOM.setup_delay -latency_file ${::IMEX::dataVar}/mmmc/views/WCCOM.setup_view/latency.sdc
create_analysis_view -name NCCOM.extra_view -constraint_mode my_constraint_mode -delay_corner NCCOM.extra_delay -latency_file ${::IMEX::dataVar}/mmmc/views/NCCOM.extra_view/latency.sdc
create_analysis_view -name BCCOM.hold_view -constraint_mode my_constraint_mode -delay_corner BCCOM.hold_delay -latency_file ${::IMEX::dataVar}/mmmc/views/BCCOM.hold_view/latency.sdc
